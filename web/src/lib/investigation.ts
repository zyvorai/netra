...
export const pages = ['overview', 'connections', 'workloads', 'explain', 'pods', 'vms', 'health', 'path', 'drops', 'congestion', 'sysctl-audit', 'node-resources', 'l7', 'surfaces', 'insights', 'topology', 'incidents', 'policies', 'flows', 'ebpf', 'audit', 'report', 'scorecard', 'talkers', 'fleet', 'traffic', 'capture'] as const;
