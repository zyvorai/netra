...
func TestBuildFindsTCPAndDNSProblems(t *testing.T) {
	a := models.AgentStatus{AgentReport: models.AgentReport{
		TCPHealth:  []models.TCPHealthStat{{Namespace: "payments", Pod: "api-1", RemoteIP: "10.0.0.8", RemotePort: 443, ActiveEstablished: 2, Retransmissions: 22, RTOs: 1, RTTSamples: 2, SRTTUS: 300000}},
	...
	if r.Summary.TCPConnections != 2 || r.Summary.TCPRetransmissions != 22 || r.Summary.DNSFailures != 2 {
		t.Fatalf("bad summary: %+v", r.Summary)
	}
	if len(r.Summary.Anomalies) < 4 {
