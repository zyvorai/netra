...
images (`0.28.0` was the first; use `0.28.1` or later). Clone a tag rather than `main`:
`git clone --branch v0.28.1 https://github.com/zyvorai/netra`. The images are signed; see
